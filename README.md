...
日本最大級の民放公式テレビポータルサイト・アプリを提供する企業で、iOSリードエンジニアとして動画配信プラットフォームの開発・改善を担当。ユーザー体験の向上とアプリの技術的な進化を推進している。
...
- 新しいwalkthroughの改善
  - ユーザーのオンボーディング体験を向上させるため、既存のwalkthroughを全面的に見直し
  - ユーザーの離脱率を下げ、アプリの使い方をより直感的に理解できるUIフローに改善
- XcodeCloudの導入
 - テストはあったもののCI環境を構築していなかったので、XcodeCloudでCI環境を構築し安全な開発サイクルを回すようにした
